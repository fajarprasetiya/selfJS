...
cl = LineClient(authToken="EI9GgldZ3G8dN6H9d4T6.IMbjROnIKdmZsgrLEKY1bG.sTaXd/QQoUxTvakuyQjaiNZSWHgnXGgUas0zUyqmgCw=")
...
sw = LineClient(authToken='EICt7L4T26mhwteBYepe.R4Bfwvj3ylcpOc8pGymjhG.qnklqrngy8/CDcLz1oqWvnQ7gSf/1I287g8OmK2clqU=')
...
responsename2 = sw.getProfile().displayName
...
wait = {
    ...
    "unsend":True,
    "mention":"ɴɢɪɴᴛɪᴘ ᴀᴊᴀ ᴋᴀ sɪɴɪ ᴍᴀsᴜᴋ ɢᴀʙᴜɴɢ..!!",
    "Respontag":"ɴɢᴇᴛᴀɢ ʟᴀɢɪ ᴛᴀᴋ ᴋᴜᴛᴜᴋ ᴊᴀᴅɪ sᴀɴᴅᴀʟ ᴊᴇᴩɪᴛ😝",
    "welcome":"sᴇʟᴀᴍᴀᴛ ᴅᴀᴛᴀɴɢ\nsᴏʙᴀᴛ ᴅɪ ʀᴏᴏᴍ ᴋᴀᴍɪ\nsᴇᴍᴏɢᴀ ʙᴇᴛᴀʜ ʏᴀ 😚🙏",
    "leave":"sᴇʟᴀᴍᴀᴛ ᴛɪɴɢɢᴀʟ sᴏʙᴀᴛ\nsᴇᴍᴏɢᴀ ᴛᴇɴᴀɴɢ ᴅɪ ᴀʟᴀᴍ sᴀɴᴀ",
...
def leaveMembers(to, mid):
    try:
        arrData = ""
        textx = "┏━━ • ʟᴇᴀᴠᴇ • ━━┓\nʙᴀᴩᴇʀ ʏᴀ ᴋᴀᴋ ".format(str(len(mid)))
        arr = []
        no = 1
        num = 2
        for i in mid:
                ...
                try:
                    if cl.getGroup(op.param1).preventedJoinByTicket == False:
                        if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                            ...
                            sw.sendMessage(op.param1,"ᴡᴀʜ ᴋɪᴄᴋᴇʀ ᴍᴀɪɴ ǫʀ ᴍɪɴᴛᴀ ᴅɪ sʟᴇᴅɪɴɢ")
            ...
            if op.param1 in ghost:
                try:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        sw.kickoutFromGroup(op.param1,[op.param2])
                        wait["blacklist"][op.param2] = True
                        sw.sendMessage(op.param1,"ᴡᴀʜ ᴋɪᴄᴋᴇʀ ʀᴇᴄᴇʜ ᴍᴀɪɴ ᴋɪᴄᴋ ᴏʀᴀɴɢ ᴍɪɴᴛᴀ ᴅɪ sʟᴇᴅɪɴɢ")
                        sw.leaveGroup(op.param1)
                        X = cl.getGroup(op.param1)
                        X.preventedJoinByTicket = True
                        cl.updateGroup(X)
                    ...
                    if msg_id in msg_dict:
                        if msg_dict[msg_id]["from"]:
                           if msg_dict[msg_id]["text"] == 'Gambarnya dibawah':
                                ...
                                ret_ += "\nᴾᴴᴷ ᵇₒᵗ"
                                ret_ += "\nCreator:  line.me/ti/p/~prast_hunter17" 
